...
// A point at radius r, angle a (radians, atan2 space: 0 = +x, +y at pi/2).
...
test("angular hysteresis wraps across the +/-pi seam", () => {
	// Octant 4 (-x) is centred on +/-pi, so holding it from a negative angle needs

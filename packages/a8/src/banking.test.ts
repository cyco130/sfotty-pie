...
test("the 130XE separates CPU and ANTIC extended RAM access", () => {
	...
	// main RAM (bit 5 high).
	machine.write(0xd301, 0xe3);
	machine.write(0x4000, 0x55); // lands in extended bank 0
